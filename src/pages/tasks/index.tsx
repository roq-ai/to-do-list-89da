...
function TaskListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<TaskInterface[]>(
    ...
    () =>
      getTasks({
        relations: ['user', 'organization', 'attachment.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('attachment', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>attachment</Th>}
                  <Th>Actions</Th>
                </Tr>
              </Thead>
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('attachment', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>{record?._count?.attachment}</Td>
                    )}
                    <Td>
